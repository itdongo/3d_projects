...
module top_new()
{
  difference() {
    union() {
      rotate_extrude()
        polygon(points=[[27.5/2,3],[31.6/2,3],[31.6/2,0],[56.8/2,0],[56.8/2,8.9],[73.7/2,4.4-2.2],[120/2,4.4-2.2],
        [120/2,4.4],[108.6/2,4.4],[108.6/2,4.4+2.7],[102.8/2,4.4+2.7],[102.8/2,4.4],[74.6/2,4.4],[50.9/2,13.2+4.8-2],[50.9/2,4.8-2],[32.6/2,4.8],[32.6/2,5.2],[27.5/2,5.2]], 
